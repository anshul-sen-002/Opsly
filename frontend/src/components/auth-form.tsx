  ...
  return (
    <div className="text-center">
      <div className="flex flex-col items-center gap-3">
        <span className="relative flex size-14 items-center justify-center overflow-hidden rounded-2xl bg-white p-1 shadow-md shadow-indigo-600/10 ring-1 ring-slate-200 dark:bg-slate-900 dark:ring-slate-700">
