 ...
 * Ensures consistent error response format and prevents stack traces leaking to clients.
 */
...
public class GlobalExceptionHandler {
    ...
    // Spring Security throws this for @PreAuthorize failures
    ...
    public ResponseEntity<ApiResponse<Void>> handleDisabledOrLocked(AuthenticationException ex) {
        return ResponseEntity.status(HttpStatus.FORBIDDEN)
